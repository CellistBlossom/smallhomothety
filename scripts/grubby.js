...
button.addEventListener("click", function() {
  ...
  var mimicName = [
    ...
    document.getElementById("grubname").innerHTML = mimicName[Math.floor((Math.random() * 100.99))];
    ...
    document.getElementById("food").innerHTML = mimicFood[Math.floor((Math.random() * 67.99))];
