...
const GRUB_IMAGES = [
    ...
    ["images/adoptable_grubs/horse_grubby.png", "A horse grub"],
    ...
    ["images/adoptable_grubs/leaf_grubby.png", "A leafeon grub"],
...
const MIMIC_IMAGES = [
    ...
    ["images/adoptable_grubs/mimic.png", "A mimic"],
    ["images/adoptable_grubs/mimic.png", "A mimic"],
    ["images/adoptable_grubs/aggrub_mimic.png", "An aggrub mimic"],
    ["images/adoptable_grubs/blomgrub_mimic.png", "A blomgrub mimic"],
    ["images/adoptable_grubs/bubble_mimic.png", "A mimic in a bubble"],
    ["images/adoptable_grubs/jar_mimic.png", "A mimic in a jar"],
...
const GRUB_NAMES = [
    ...
    "Grubble the Grub",
    "Grubble the Grubbest",
    "Grubble the Grubbiest",
    "Grubble the Grubby",
    "Grubble",
    "Grubbleberry",
    "Grubbleboo",
...
button.addEventListener("click", function() {
    ...
    if (grubbynumber > 5) {
        ...
        if (oldgrubbynumber <= 5) {
            meemawmaw.pause();
            meemawmaw = new Audio('/music/grub_idle_or_look_1.ogg');
        }
        ...
        if (oldgrubbynumber > 5) {
            meemawmaw.pause();
            meemawmaw = new Audio('/music/grub_mimic_charge_loop.wav');
        }
